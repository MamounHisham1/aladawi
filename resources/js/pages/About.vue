        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-12">
                <div class="text-center mb-8">
                    <div class="w-32 h-32 mx-auto mb-6 bg-gray-300 dark:bg-gray-600 rounded-full flex items-center justify-center">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-12">
                <h3 class="text-2xl font-semibold text-gray-900 dark:text-white mb-6 rtl-text">الكتب المتاحة على الموقع</h3>
                <div class="rtl-content">
                    <p class="text-lg leading-relaxed mb-6">
                        يحتوي هذا الموقع على مجموعة من كتب الشيخ مصطفى العدوي المتاحة للقراءة والتحميل، مقسمة حسب التخصصات:
                    </p>
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <!-- Fiqh Books -->
                        <div>
                            <h4 class="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-3 rtl-text">📚 كتب الفقه</h4>
                            <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                                <li>• جامع أحكام النساء - أسئلة تطبيقية (2023)</li>
                                <li>• فقه التعامل بين الزوجين وقبسات من بيت النبوة (2012)</li>
                                <li>• أحكام الطلاق في الشريعة الإسلامية (2011)</li>
                                <li>• الترشيد (2012)</li>
                                <li>• يواقيت الفلاة في مواقيت الصلاة (2012)</li>
                            </ul>
                        </div>
                        
                        <!-- Hadith Books -->
                        <div>
                            <h4 class="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-3 rtl-text">📖 كتب الحديث</h4>
                            <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                                <li>• الصحيح المسند من أحاديث الفتن والملاحم وأشراط الساعة (2017)</li>
                                <li>• النور الساري في شرح صحيح البخاري (2016)</li>
                                <li>• أخبار الدجال وابن صياد (2012)</li>
                            </ul>
                        </div>
                        
                        <!-- Tafsir Books -->
                        <div>
                            <h4 class="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-3 rtl-text">📜 كتب التفسير</h4>
                            <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                                <li>• مختصر صحيح تفسير ابن كثير (2015)</li>
                                <li>• تفسير الربانيين لعموم المؤمنين (تفسير جزء عم) (2012)</li>
                                <li>• قصة أصحاب الجنة (2016)</li>
                            </ul>
                        </div>
                        
                        <!-- General Books -->
                        <div>
                            <h4 class="text-lg font-semibold text-emerald-600 dark:text-emerald-400 mb-3 rtl-text">🌟 كتب عامة</h4>
                            <ul class="space-y-2 text-gray-700 dark:text-gray-300">
                                <li>• شفاء القلوب (2014)</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 text-center">
                        <Link 
                            ...
                            class="inline-flex items-center px-6 py-3 bg-emerald-600 text-white text-base font-medium rounded-md hover:bg-emerald-700 transition-colors duration-200 rtl-text"
                        >
                            تصفح جميع الكتب
            ...
            <!-- Website Disclaimer -->
            <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-8 mb-12">
                <div class="flex items-start">
                    <svg class="w-6 h-6 text-amber-600 dark:text-amber-400 mt-1 ml-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                    </svg>
                    <div class="rtl-content">
                        <h3 class="text-lg font-semibold text-amber-800 dark:text-amber-200 mb-2 rtl-text">
                            تنويه مهم حول الموقع
                        </h3>
                        <p class="text-amber-700 dark:text-amber-300 leading-relaxed">
                            هذا الموقع الإلكتروني غير تابع مباشرة لفضيلة الشيخ مصطفى العدوي، وإنما هو موقع مستقل يهدف إلى نشر علم الشيخ وكتبه ومحاضراته لتعم الفائدة. الموقع من تطوير وإدارة فريق تقني مستقل، ولا يمثل الشيخ بشكل رسمي. جميع المحتويات المنشورة هي من المواد العلمية المتاحة للشيخ والتي تم جمعها وتنظيمها لسهولة الوصول إليها.
                        </p>
                    </div>
                </div>
            </div>
